...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\app-art-manage\public\storage' => 'string',
...
'filesystems.links.C:\\xampp\\htdocs\\app-art-manage\\public\\storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'password.email','password.update','register','register.post','user-profile-information.update',
...
'livewire.update','livewire.upload-file','livewire.preview-file','verification.notice','verification.verify',
'verification.send','dashboard','jurusan.data','jurusan.index','jurusan.create',
'jurusan.store','jurusan.show','jurusan.edit','jurusan.update','jurusan.destroy',
'prodi.data','prodi.index','prodi.create','prodi.store','prodi.show',
'prodi.edit','prodi.update','prodi.destroy','bidang.data','bidang.index',
'bidang.create','bidang.store','bidang.show','bidang.edit','bidang.update',
'bidang.destroy','alat.data','alat.index','alat.create','alat.store',
'alat.show','alat.edit','alat.update','alat.destroy','anggota.approve',
'anggota.reject','anggota.data','anggota.cetak_anggota','anggota.get_prodi','anggota.index',
'anggota.create','anggota.store','anggota.show','anggota.edit','anggota.update',
'anggota.destroy','peminjaman_alat.approve','peminjaman_alat.reject','peminjaman_alat.confirm_pickup','peminjaman_alat.process_return',
'peminjaman_alat.destroy','peminjaman_alat.cetak_peminjaman','agenda_kegiatan.data','agenda_kegiatan.cetak_agenda','agenda_kegiatan.index',
'agenda_kegiatan.create','agenda_kegiatan.store','agenda_kegiatan.show','agenda_kegiatan.edit','agenda_kegiatan.update',
'agenda_kegiatan.destroy','agenda_kegiatan.preview','kehadiran_kegiatan.get_anggota_by_bidang','kehadiran_kegiatan.data',
'agenda_kegiatan.get_detail','kehadiran_kegiatan.cetak_kehadiran','kehadiran_kegiatan.index','kehadiran_kegiatan.create','kehadiran_kegiatan.store',
'kehadiran_kegiatan.show','kehadiran_kegiatan.edit','kehadiran_kegiatan.update','kehadiran_kegiatan.destroy','kehadiran_kegiatan.preview',
'laporan.index','laporan.export_pdf','peminjaman_alat.index','peminjaman_alat.store','peminjaman_alat.show',
'peminjaman_alat.data','anggota.find_by_nim','alat.find_by_id','user.profil','user.update_profil',
'storage.local',);
        registerArgumentsSet('views', 
'agenda_kegiatan.cetak','agenda_kegiatan.form','agenda_kegiatan.index','alat.form','alat.index',
'anggota.cetak','anggota.form','anggota.index','api.api-token-manager','api.index',
'auth.confirm-password','auth.forgot-password','auth.login','auth.login1','auth.register',
'auth.reset-password','auth.two-factor-challenge','auth.verify-email','bidang.form','bidang.index',
...
'components.switchable-team','components.validation-errors','components.welcome','dashboard','dashboard_admin.dashboard',
'dashboard_anggota.dashboard','emails.team-invitation','jurusan.form','jurusan.index','kehadiran_kegiatan.cetak',
'kehadiran_kegiatan.form','kehadiran_kegiatan.index','laporan.form','laporan.index','laporan.pdf',
'layouts.app','layouts.auth','layouts.auth1','layouts.footer','layouts.guest',
'layouts.header','layouts.master','layouts.sidebar','navigation-menu','peminjaman_alat.cetak',
'peminjaman_alat.detail','peminjaman_alat.form','peminjaman_alat.index','policy','prodi.form',
'prodi.index','profile.delete-user-form','profile.logout-other-browser-sessions-form','profile.show','profile.two-factor-authentication-form',
'profile.update-password-form','profile.update-profile-information-form','terms','user.profil','welcome',
'cloudinary::components.image','cloudinary::components.video','cloudinary::components.widget','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
