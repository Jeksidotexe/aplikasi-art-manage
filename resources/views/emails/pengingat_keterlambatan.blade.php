...
<head>
    <meta charset="UTF-8">
    <title>Pemberitahuan Keterlambatan</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                Sistem kami mencatat bahwa peminjaman alat berikut telah melewati batas waktu pengembalian:
            </p>
            <ul>
                ...
                <li><strong>Jatuh Tempo:</strong> <strong style="color: #d9534f;">{{
                        \Carbon\Carbon::parse($peminjaman->tanggal_harus_kembali)->translatedFormat('d F Y') }}</strong>
                </li>
            </ul>
            <p>
                Mohon untuk segera mengembalikan alat tersebut ke sekretariat untuk menghindari sanksi lebih lanjut.
            </p>
